...
import { updateSaleDetails } from "@/apis/data/sales-client";
...
export default function SaleDetailsForm({ saleId, initial }: Props) {
  ...
  return (
    <OperatorSaleWizardShell
      ...
      description="Title and description appear on the public listing."
    >
      <div className="mt-8 space-y-6 rounded-2xl border border-border bg-card p-6 shadow-sm">
        ...
        <div className="space-y-2">
          <label htmlFor="sale-title" className="text-sm font-medium text-foreground">
            Title
          </label>
          <Input
            id="sale-title"
        ...
        <div className="space-y-2">
          <label htmlFor="sale-description" className="text-sm font-medium text-foreground">
            Description
          </label>
          <textarea
            id="sale-description"
            ...
            rows={6}
            placeholder="What buyers should know — highlights, payment, parking…"
            className={cn(
